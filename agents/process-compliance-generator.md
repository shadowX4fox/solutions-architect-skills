...
description: Hermes — Process Transformation Compliance Contract Generator - Generates Process Transformation compliance contracts from ARCHITECTURE.md
...
bun skills/architecture-compliance/utils/score-calculator-cli.ts \
  /tmp/populated_process_contract.md \
  validation/process_transformation_validation.json
```

**Output**: JSON with validation score, written to `/tmp/validation_score_process.json`
...
bun skills/architecture-compliance/utils/field-updater-cli.ts \
  /tmp/populated_process_contract.md \
  /tmp/validation_score_process.json \
  /tmp/final_process_transformation_contract.md
```

**What This Does**:
- Reads populated contract from Step 4.6.1 input
- Reads validation score JSON from `/tmp/validation_score_process.json`
...
- Writes final contract to `/tmp/final_process_transformation_contract.md`
