...
bun skills/architecture-compliance/utils/score-calculator-cli.ts \
  /tmp/populated_data_ai_contract.md \
  validation/data_ai_architecture_validation.json
```

**Output**: JSON with validation score, written to `/tmp/validation_score_data_ai.json`
...
bun skills/architecture-compliance/utils/field-updater-cli.ts \
  /tmp/populated_data_ai_contract.md \
  /tmp/validation_score_data_ai.json \
  /tmp/final_data_ai_architecture_contract.md
```

**What This Does**:
- Reads populated contract from Step 4.6.1 input
- Reads validation score JSON from `/tmp/validation_score_data_ai.json`
...
- Writes final contract to `/tmp/final_data_ai_architecture_contract.md`
