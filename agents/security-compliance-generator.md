...
```bash
bun skills/architecture-compliance/utils/score-calculator-cli.ts /tmp/populated_security_contract.md validation/security_architecture_validation.json
bun skills/architecture-compliance/utils/field-updater-cli.ts /tmp/populated_security_contract.md /tmp/validation_score_security.json /tmp/final_security_architecture_contract.md
```
