...
bun skills/architecture-compliance/utils/score-calculator-cli.ts \
  /tmp/populated_security_contract.md \
  validation/security_architecture_validation.json
```

**Output**: JSON with validation score, written to `/tmp/validation_score_security.json`
...
bun skills/architecture-compliance/utils/field-updater-cli.ts \
  /tmp/populated_security_contract.md \
  /tmp/validation_score_security.json \
  /tmp/final_security_architecture_contract.md
```

**What This Does**:
- Reads populated contract from Step 4.6.1 input
- Reads validation score JSON from `/tmp/validation_score_security.json`
...
- Writes final contract to `/tmp/final_security_architecture_contract.md`
